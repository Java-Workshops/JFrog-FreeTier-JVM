...
#    echo skip building, image already existing - svenruppert/maven-3.6.1-adopt 1.8.0-172
    ...
    docker tag svenruppert/maven-3.6.3-adopt:latest svenr-docker.jfrog.io/svenruppert/maven-3.6.3-adopt:1.8.0-172
    docker push svenr-docker.jfrog.io/svenruppert/maven-3.6.3-adopt:1.8.0-172
#fi
